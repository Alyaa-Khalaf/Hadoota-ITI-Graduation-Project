  ...
  return (
    ...
    >
          ...
          return (
            ...
            >
              <motion.div
                ...
                className={`absolute w-24 h-24 rounded-full blur-2xl opacity-40 ${topic.color}`}
              />
      ...
      {selectedTopic && (
        ...
        >
          <motion.div
            animate={{ y: [0, -10, 0], rotate: [0, 5, -5, 0], scale: [1, 1.1, 1] }}
            transition={{ duration: 2, repeat: Infinity }}
            className="text-6xl"
          >
            {selectedTopic.emoji}
          ...
          <motion.div
            animate={{ y: [0, -12, 0], scale: [1, 1.12, 1], rotate: [0, 1, -1, 0] }}
