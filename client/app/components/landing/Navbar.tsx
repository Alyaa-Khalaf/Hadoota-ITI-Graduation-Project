...
// استيراد الزرار الموحد بالمسار النسبي المظبوط
  ...
  return (
    ...
    >
      <div className="container mx-auto flex items-center justify-between">
        ...
        {/* logo */}
        <Link href="/" className="flex items-center gap-2 text-2xl font-black text-sky tracking-wide font-sans">
          <span>حدوتة</span>
        ...
        <nav className="hidden items-center gap-10 text-base font-bold text-ink-muted md:flex font-sans">
          <Link href="#features" className="transition hover:text-ink">المميزات</Link>
          <Link href="#how-it-works" className="transition hover:text-ink">كيف تعمل</Link>
          <Link href="#testimonials" className="transition hover:text-ink">الآراء</Link>
