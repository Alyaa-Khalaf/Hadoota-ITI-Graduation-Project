...
export default function ScreenTimeReportSection({ childId }: Props) {
          ...
          <div className="flex bg-gray-100 rounded-md p-0.5 text-xs">
            <button
              ...
              className={`px-3 py-1 rounded-md transition-colors ${
                mode === "today" ? "bg-orange-500 text-white" : "text-gray-500"
              }`}
            >
              اليوم
            </button>
            <button
              ...
              className={`px-3 py-1 rounded-md transition-colors ${
                mode === "week" ? "bg-orange-500 text-white" : "text-gray-500"
              }`}
            >
              الأسبوع
            </button>
            ...
            <div className="w-full h-2 bg-gray-100 rounded-full overflow-hidden">
              <div
                className={`h-full rounded-full ${
                  today.allowed ? "bg-orange-500" : "bg-red-500"
                }`}
                style={{
          ...
          <div className="space-y-4">
            <div dir="rtl" className="flex justify-between items-center border-b pb-3">
              <div>
                ...
                <p className="text-lg font-bold text-orange-600">{week.weekTotal} دقيقة</p>
              </div>
              ...
              {week.days.map((day, i) => {
                ...
                return (
                  <div key={i} className="space-y-1">
                    ...
                    <div className="w-full h-2 bg-gray-100 rounded-full overflow-hidden">
                      <div
                        className={`h-full rounded-full ${isOverLimit ? "bg-red-500" : "bg-orange-500"}`}
                        style={{ width: `${percent}%` }}
                      />
                    </div>
                  </div>
